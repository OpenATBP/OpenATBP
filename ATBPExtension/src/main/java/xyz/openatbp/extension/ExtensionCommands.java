...
public class ExtensionCommands {
     ...
     * @param fxId - ID of the specific effect (similar to a player id). This does not need to be
     *     pre-exisiting.
     ...
     */
    public static void createActorFX(
    ...
    public static void updateActorData(
            ATBPExtension parentExt, Room room, String id, HashMap<String, Double> values) {
        String[] intVals = {
            "kills",
            "assists",
            "deaths",
    ...
    public static void updateActorData(
            ATBPExtension parentExt, Room room, String id, String key, double value) {
        try {
            String[] intVals = {
                "kills",
                "assists",
    ...
    public static void updateActorData(
            ATBPExtension parentExt, Room room, String id, ISFSObject data) {
        data.putUtfString("id", id);
        for (User u : room.getUserList()) {
            parentExt.send("cmd_update_actor_data", data, u);
        }
    ...
    public static void moveActor(
        ...
        // if(id.contains("neptr")) System.out.println(id + ": (" + p.getX() + "," + p.getY() +") to
        // ("
        // + d.getX() + "," + d.getY() + ") at " + speed);
     ...
     */
    public static void attackActor(
            ATBPExtension parentExt,
            Room room,
            String id,
            String target,
     ...
     */
    public static void createProjectileFX(
            ATBPExtension parentExt,
            Room room,
            String fxName,
            String attackerId,
     ...
     */
    public static void knockOutActor(
            ATBPExtension parentExt, Room room, String id, String attackerId, int deathTime) {
        for (User u : room.getUserList()) {
            ISFSObject data = new SFSObject();
            data.putUtfString("id", id);
    ...
    public static void knockOutActor(
            ATBPExtension parentExt, User u, String id, String attackerId, int deathTime) {
        ISFSObject data = new SFSObject();
        data.putUtfString("id", id);
        data.putUtfString("attackerId", attackerId);
        data.putInt("deathTime", deathTime * 1000);
     ...
     */
    public static void createWorldFX(
            ATBPExtension parentExt,
            User u,
            String id,
            String bundle,
     ...
     */
    public static void swapActorAsset(
            ATBPExtension parentExt, Room room, String id, String bundle) {
        for (User u : room.getUserList()) {
            ISFSObject data = new SFSObject();
    ...
    public static void playSound(
            ATBPExtension parentExt, Room room, String id, String name, Point2D source) {
        if (id == null) id = "";
        for (User u : room.getUserList()) {
            ISFSObject data = new SFSObject();
    ...
    public static void playSound(
            ATBPExtension parentExt, User u, String id, String name, Point2D source) {
        ISFSObject data = new SFSObject();
        data.putUtfString("name", name);
        data.putUtfString("id", id);
        data.putFloat("x", (float) source.getX());
     ...
     */
    public static void actorAbilityResponse(
            ATBPExtension parentExt,
            User u,
            String id,
            boolean canCast,
     ...
     */
    public static void updateActorState(
            ATBPExtension parentExt, Room r, String id, ActorState state, boolean enabled) {
    ...
    public static void createProjectile(
        ...
        ExtensionCommands.createActor(
                parentExt, room, owner.getId() + id, id, loc, 0f, owner.getTeam());
    ...
    public static void handleDeathRecap(
            ATBPExtension parentExt,
            User u,
            String id,
            String killerId,
        ...
        for (Actor a : aggressors.keySet()) {
            ...
            for (String k : attackData.getKeys()) {
                if (k.contains("attack")) {
                    ...
                    if (attack.getUtfString("atkType").equalsIgnoreCase("physical"))
                        totalPhysical += attack.getInt("atkDamage");
    ...
    public static void updateAltar(
            ATBPExtension parentExt, Room room, int altarNum, int team, boolean locked) {
        ISFSObject data = new SFSObject();
    ...
    public static void addStatusIcon(
            ATBPExtension parentExt,
            User u,
            String name,
            String desc,
    ...
    public static void actorAnimate(
            ATBPExtension parentExt,
            Room room,
            String id,
            String animation,
    ...
    public static void knockBackActor(
            ATBPExtension parentExt,
            Room room,
            String id,
            Point2D loc,
